...
+===================+============+==========================+============================+
| Intraabdominal    | None       | Present <br>            | Persistent after source    |
| source            |            | (perforation, ischemia)  | <br>control                |
+-------------------+------------+--------------------------+----------------------------+
| Frequency         | \~1% of    | 80-90% of cases          | Less common                |
|                   | perit    |                          |                            |
|                   | onitis     |                          |                            |
+-------------------+------------+--------------------------+----------------------------+
| Typical           | Mon        | Polymicrobial            | MDR, gram - negative <br>  |
|                   | omicrobial | aerobic/anaerobic        | low irulence               |
| organisms         | gram-      |                          |                            |
|                   | negative   |                          |                            |
+-------------------+------------+--------------------------+----------------------------+
...
|                | re-associated, | gram-negatives, |
|                | recent         | MRSA, Candida,  |
|                | surgery, imm   | enterococci     |
|                | unosuppressed, |                 |
|                | prolonged h    |                 |
|                | ospitalization |                 |
+----------------+----------------+-----------------+
...
+==============+==============+==============+
| ## \*\       | 875-125 mg   | Oral;        |
| *Amoxicillin | TID          | limited      |
|              |              | spectrum     |
| cla          |              |              |
| vulanate\*\* |              |              |
+--------------+--------------+--------------+
| **Ampicill i | 3 g IV Q6H   | Good         |
| n            |              | anaerobic    |
| -sulbactam** |              | coverage     |
+--------------+--------------+--------------+
| *            | 4.5 g IV     | Excellent    |
...
+================+===================+================+
| Ceftoloz       | Pseudomonas,      | Health         |
| ane-tazobactam | resistant GN      | ca             |
|                |                   | re-associated, |
|                |                   | MDR risk       |
+----------------+-------------------+----------------+
| Ceftazi        | Car               | Suspected      |
| dime-avibactam | bapenem-resistant | resistance,    |
|                | organisms, ESBLs  | prior          |
|                |                   | carbapenems    |
+----------------+-------------------+----------------+
| Meropen        | M e t             | Last-resort    |
| em-vaborbactam | a                 | therapy        |
|                | llo-β-lactamases, |                |
|                | car               |                |
|                | bapenem-resistant |                |
+----------------+-------------------+----------------+
...
+----------------+------------------+----------------+
| I*             | Minimally        | Formal         |
| *nvasiveness** | invasive         | operation      |
+----------------+------------------+----------------+
