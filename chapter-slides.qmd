...
+-----------------------------+-------------------------------+
| !                           | ![](images/u%20n%20i%20p%20d  |
| [](images/d%20m%20m%20u%20n | _seal_white.svg){width="100"} |
| ipd_logo.jpeg){width="100"} |                               |
+-----------------------------+-------------------------------+
...
|             |             | ischemia)   |             |
+-------------+-------------+-------------+-------------+
| -   \*Fr    | \~1% of     | 80-90% of   | Less common |
| equency\*\* | peritonitis | cases       |             |
+-------------+-------------+-------------+-------------+
| **Typical   | M           | P           | MDR, g      |
| organisms** | o           | o           | r           |
|             | nomicrobial | lymicrobial | am-negative |
|             | g           | ae r o b    | <br         |
|             | r           | i           | > l         |
|             | am-negative | c/anaerobic | o           |
|             |             |             | w-virulence |
+-------------+-------------+-------------+-------------+
| -   \*Mo    | 5-20%       | 10-40%      | 30-64%      |
| rtality\*\* |             |             |             |
...
+-----------------------------+-------------------------------+
| **Small bowel**             | Meckel's diverticulitis,      |
...
|                             | cholangitis                   |
+-----------------------------+-------------------------------+
| **Gynecologic**             | Ruptured tubo-ovarian         |
|                             | abscess, perforated ovarian   |
|                             | cyst                          |
+-----------------------------+-------------------------------+
...
| Agent           | Dosing             | Notes           |
+=================+====================+=================+
| **Amoxicil l    | 875-125 mg TID     | Oral; limited   |
| i               |                    | spectrum        |
| n-clavulanate** |                    |                 |
+-----------------+--------------------+-----------------+
| **Ampic i       | 3 g IV Q6H         | Good anaerobic  |
| l               |                    | coverage        |
| lin-sulbactam** |                    |                 |
+-----------------+--------------------+-----------------+
| **Piperaci l    | 4.5 g IV Q6-8H     | Excellent       |
| l               |                    | coverage;       |
| in-tazobactam** |                    | pseudomonal     |
+-----------------+--------------------+-----------------+
...
| Agent           | Dosing             | Notes           |
+=================+====================+=================+
| **Ceftriaxone** | 2 g IV Q12H +      | Lower           |
|                 | metronidazole 500  | pseudomonal     |
|                 | mg TID             | coverage        |
+-----------------+--------------------+-----------------+
| **Ceftazidime** | 2 g IV Q8H +       | Better          |
|                 | metronidazole 500  | *Pseudomonas*   |
|                 | mg TID             | coverage        |
+-----------------+--------------------+-----------------+
...
+================+=========================+================+
| Ceftoloz       | Pseudomonas, resistant  | Health c       |
| ane-tazobactam | GN                      | a              |
|                |                         | re-associated, |
|                |                         | MDR risk       |
+----------------+-------------------------+----------------+
...
|                |                | hospitalization         |
+----------------+----------------+-------------------------+
| Anidulafungin  | 200 mg         | Suspected               |
|                | loading, then  | azole-resistant Candida |
|                | 100 mg/day     |                         |
+----------------+----------------+-------------------------+
...
|                |                | azole-resistant Candida |
+----------------+----------------+-------------------------+
| Liposomal      | 3-5 mg/kg/day  | Suspected               |
| amphotericin B |                | azole-resistant         |
|                |                | Candida, nephrotoxic    |
+----------------+----------------+-------------------------+
...
+=================+====================+=================+
| -   \*Gr        | 60-80%             | *S.             |
| am-positive\*\* |                    | epidermidis, S. |
|                 |                    | aureus,         |
|                 |                    | Streptococcus   |
|                 |                    | spp.*           |
+-----------------+--------------------+-----------------+
| -   \*Gr        | 15-30%             | *E. coli,       |
| am-negative\*\* |                    | Klebsiella*,    |
|                 |                    | E               |
|                 |                    | nterobacterales |
+-----------------+--------------------+-----------------+
...
|                | mg/2 L                     | Pseudomonas    |
+----------------+----------------------------+----------------+
| **Vancomycin** | 30 mg/kg loading / 15      | MRSA,          |
|                | mg/kg per exchange         | resistant      |
|                |                            | gram-positive  |
+----------------+----------------------------+----------------+
...
measuring up to 10.2 cm in the right paracolic gutter and 13.6 cm in the
pelvis. These may represent seromas in the postsurgical setting versus
abscesses.

2\. Mild mesenteric fat stranding in the lower abdomen and pelvis,
likely related to postsurgical changes within acute inflammatory process
not excluded.
...
|                |                        | visualization   |
+----------------+------------------------+-----------------+
| Invasiveness   | Minimally invasive     | Formal          |
|                |                        | operation       |
+----------------+------------------------+-----------------+
...
|                |                        | incisions)      |
+----------------+------------------------+-----------------+
| **Efficacy**   | 80-90% success         | Near 100%       |
|                |                        | success         |
+----------------+------------------------+-----------------+
| **Best used    | Accessible             | Inaccessible    |
| in**           | collections, stable    | collections,    |
|                | patient                | unstable        |
|                |                        | patient         |
+----------------+------------------------+-----------------+
...
|                              | disease                      |
+------------------------------+------------------------------+
| **Patient age,               | Older, immunocompromised →   |
| comorbidities**              | worse                        |
+------------------------------+------------------------------+
...
+------------+------------+------------+------------+
| Clinical   | First-Line | A          | Duration   |
| Scenario   | Empiric    | lternative |            |
+============+============+============+============+
| **Primary  | Cefotaxime | C i        | 5 days     |
| p          | 2g Q6-8H   | p          |            |
| eritonitis |            | rofloxacin |            |
| (SBP)**    |            | 400mg PO   |            |
|            |            | Q12H       |            |
+------------+------------+------------+------------+
| *          | Piperacil  | C          | 10-14 days |
| *Secondary | l i n      | eftriaxone |            |
| p          | -          | 2g Q12H +  |            |
| e          | tazobactam | m e        |            |
| ritonitis, | 4.5g Q6-8H | t          |            |
| CA**       |            | ronidazole |            |
|            |            | 500mg TID  |            |
+------------+------------+------------+------------+
| *          | C e p h    | Carbapenem | 10-14 days |
| *Secondary | a          | ±          |            |
| p          | losporin + | a          |            |
| e          | v          | nti-fungal |            |
| ritonitis, | a          |            |            |
...
|            | ti-Candida |            |            |
+------------+------------+------------+------------+
| **CAPD p e | Cefazolin  | Vancomycin | 14-21 days |
| r          | IP +       | IP         |            |
| itonitis** | c          |            |            |
|            | eftazidime |            |            |
|            | IP         |            |            |
+------------+------------+------------+------------+
| **In t r a | Piperacil  | C e        | 10-14 days |
| -          | l i n      | f          |            |
| peritoneal | -          | triaxone + |            |
| abscess**  | tazobactam | m e        |            |
|            | 4.5g Q6-8H | t          |            |
|            |            | ronidazole |            |
+------------+------------+------------+------------+
