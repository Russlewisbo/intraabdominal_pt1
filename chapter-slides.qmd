...
| Agent        | Dosing       | Notes        |
+==============+==============+==============+
| **Amoxicil l | 875-125 mg   | Oral;        |
| i n -        | TID          | limited      |
| c            |              | spectrum     |
| lavulanate** |              |              |
+--------------+--------------+--------------+
| **Ampic i l  | 3 g IV Q6H   | Good         |
| l i          |              | anaerobic    |
| n            |              | coverage     |
| -sulbactam** |              |              |
+--------------+--------------+--------------+
| **Piperaci l | 4.5 g IV     | Excellent    |
| l i n        | Q6-8H        | coverage;    |
| -            |              | pseudomonal  |
| tazobactam** |              |              |
+--------------+--------------+--------------+
...
| -   \*C      | 2 g IV Q8H + | Better       |
|              | m            | *            |
| e            | etronidazole | Pseudomonas* |
| f            | 500 mg TID   | coverage     |
| tazidime\*\* |              |              |
+--------------+--------------+--------------+
...
|                |                   | MDR risk       |
+----------------+-------------------+----------------+
| Ceftazi        | C a               | Suspected      |
| dime-avibactam | r                 | resistance,    |
|                | bapenem-resistant | prior          |
