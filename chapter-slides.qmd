...
+-------------------------------+---------------------------------+
| ![](images/d%20m%20m          | ![](images/u%20n%20i            |
| unipd_logo.jpeg){width="100"} | pd_seal_white.svg){width="100"} |
+-------------------------------+---------------------------------+
...
+===============+===============+===============+===============+
|               | None          | Present <b    | Persistent    |
| **I           |               | r             | after source  |
| ntraabdominal |               | >             | control       |
| source**      |               | (perforation, |               |
|               |               | ischemia)     |               |
+---------------+---------------+---------------+---------------+
| **Frequency** | \~1% of       | 80-90% of     | Less common   |
|               | peritonitis   | cases         |               |
+---------------+---------------+---------------+---------------+
| **Typical     | Monomicrobial | Polymicrobial | MDR,          |
| organisms**   | gram-negative | ae r          | gram-negative |
|               |               | o             | <br           |
|               |               | bic/anaerobic | >             |
|               |               |               | low-virulence |
+---------------+---------------+---------------+---------------+
...
<br> ::: aside The predominance of gram-negatives reflects bacterial
translocation from the GI tract. *S. aureus* is unusual (2-4% of cases)
and may indicate umbilical hernia erosion. Anaerobes are reported
infrequently, possibly due to the bacteriostatic activity of ascites
against *Bacteroides spp.* and the relatively high oxygen tension in
peritoneal fluid. In pediatric cases, hematogenous spread of *S.
pneumoniae* is more common. :::
...
::: notes
The SAA gradient helps exclude portal hypertension as the cause of
ascites. A positive culture with PMN \>250 is diagnostic. However,
antibiotics may be initiated before culture results, making the PMN
count critical. Blood culture bottles increase yield for
culture-negative cases. Glucose typically low in SBP, amylase may be
elevated in pancreatic disease.
:::

------------------------------------------------------------------------

## SBP variants: Monomicrobial <br> nonneutrocytic bacterascites {.smaller}
...
## SBP variants: <br> Culture-negative Nnutrocytic ascites {.smaller}
...
## Primary peritonitis diagnosis: Recommended aracentesis protocol {.smaller}

<br> **Universal Recommendation for Cirrhotic Patients**
...
## Treatment of SBP: Empiric therapy <br> <br>
...
+===============================+=================================+
| **Upper GI**                  | Perforated peptic ulcer,        |
|                               | perforated gastric ulcer        |
+-------------------------------+---------------------------------+
| **Small bowel**               | Meckel's diverticulitis, small  |
|                               | bowel perforation, ischemic     |
|                               | necrosis                        |
+-------------------------------+---------------------------------+
| **Appendix**                  | Perforated appendicitis         |
+-------------------------------+---------------------------------+
| **Colon**                     | Diverticulitis (perforation),   |
|                               | toxic megacolon, ischemic       |
|                               | colitis                         |
+-------------------------------+---------------------------------+
| **Biliary**                   | Perforation of gallbladder,     |
|                               | cholangitis                     |
+-------------------------------+---------------------------------+
| **Gynecologic**               | Ruptured tubo-ovarian abscess,  |
|                               | perforated ovarian cyst         |
+-------------------------------+---------------------------------+
| **Trauma**                    | Iatrogenic or penetrating       |
|                               | perforation                     |
+-------------------------------+---------------------------------+
...
-   Aerobic-anaerobic polymicrobial common
...
+===================+===================+======================+
| **Gram-negative   | *E. coli,         | 60-80%               |
| rods**            | Klebsiella,       |                      |
|                   | Proteus,          |                      |
|                   | Enterobacter*     |                      |
+-------------------+-------------------+----------------------+
| **Anaerobes**     | *Bacteroides      | 60-90%               |
|                   | fragilis*,        |                      |
|                   | anaerobic cocci,  |                      |
|                   | *Clostridium*     |                      |
+-------------------+-------------------+----------------------+
| **Gram-positive   | *Streptococcus,   | 40-60%               |
| cocci**           | Enterococcus,     |                      |
|                   | Staphylococcus*   |                      |
+-------------------+-------------------+----------------------+
...
::: aside
This synergy concept explains why inadequate anaerobic coverage leads to
treatment failure, recurrent fever, and abscess formation even when
...
## Pathophysiology: Systemic response to secondary peritonitis <br> <br> {.smaller}

-   **SIRS (Systemic Inflammatory Response Syndrome)** - Fever,
    tachycardia, tachypnea, leukocytosis - Results from TNF-α, IL-1,
    IL-6 release - May progress to sepsis and multiorgan failure

-   **Hemodynamic Changes** - Initial phase: vasoconstriction
    (compensatory) - Late phase: vasodilation and increased capillary
    permeability - Hypovolemia and hypotension (septic shock)

-   **Organ Dysfunction** - Renal hypoperfusion → acute kidney injury -
    Pulmonary capillary leak → ARDS - Hepatic dysfunction →
    coagulopathy - GI hypomotility → ileus

-   **Mortality Correlation** - Extent of organ dysfunction predicts
    outcome - Reflected in APACHE II [@Ref176] score, Mannheim
    Peritonitis Index [@Ref178] - Delayed recognition/treatment
    increases mortality
...
## Diagnostic workup: <br> Laboratory studies {.smaller}

**Complete Blood Count** - WBC elevation (typically 12,000-20,000) -
Left shift (immature bands) indicates severity - Absence of leukocytosis
does not exclude peritonitis
...
| Test                    | Utility                               |
+=========================+=======================================+
| **C-reactive protein    | Elevated; reflects severity           |
| (CRP)**                 |                                       |
+-------------------------+---------------------------------------+
| **Procalcitonin**       | \>2 ng/mL suggests bacterial          |
|                         | peritonitis; guides de-escalation     |
+-------------------------+---------------------------------------+
| **Lactate**             | Elevated in sepsis; correlates with   |
|                         | severity                              |
+-------------------------+---------------------------------------+

**Chemistry** - Renal function (creatinine, BUN) - Electrolytes
(hypokalemia common from GI losses) - Liver function tests - Glucose
(hyperglycemia or hypoglycemia possible)

**Blood Cultures** - Obtain before antibiotics if possible - Positive in
20-40% of secondary peritonitis - Guide specific organism coverage
...
necessitate immediate surgical exploration without imaging. The presence
of pneumoperitoneum is virtually diagnostic of perforation and indicates
...
::: aside
The three panel C T scan of abdomen and pelvis with coronal views. Panel
...
+-----------------------------------+-----------------------------+
| **PMN count**                     | Usually \>50,000/mm³ in     |
|                                   | secondary peritonitis       |
+-----------------------------------+-----------------------------+
| **Gram stain**                    | May show gram-negative      |
|                                   | rods, gram-positive cocci,  |
|                                   | anaerobes                   |
+-----------------------------------+-----------------------------+
| **Culture**                       | Polymicrobial growth        |
|                                   | expected                    |
+-----------------------------------+-----------------------------+
...
::: aside
Tertiary peritonitis represents a transition to palliative care in many
cases. Aggressive re-exploration without a clear target often worsens
outcomes. The focus should shift toward supportive care, optimal
antibiotic coverage guided by cultures, and discussion of realistic
goals given high mortality.
:::

------------------------------------------------------------------------

## Antimicrobial therapy for secondary peritonitis: <br>An overview
...
+=====================+================+=========================+
| **Low-risk**        | Commu          | Susceptible             |
|                     | nity-acquired, | gram-negatives,         |
|                     | no recent      | anaerobes               |
|                     | ho             |                         |
|                     | spitalization, |                         |
|                     | no             |                         |
...
|                     | unosuppression |                         |
+---------------------+----------------+-------------------------+
| **High-risk**       | Healthca       | MDR gram-negatives,     |
|                     | re-associated, | MRSA, Candida,          |
|                     | recent         | enterococci             |
|                     | surgery,       |                         |
|                     | imm            |                         |
|                     | unosuppressed, |                         |
...
| Agent             | Dosing               | Notes             |
+===================+======================+===================+
| **Amoxicil        | 875-125 mg TID       | Oral; limited     |
| lin-clavulanate** |                      | spectrum          |
+-------------------+----------------------+-------------------+
| **Ampic           | 3 g IV Q6H           | Good anaerobic    |
| illin-sulbactam** |                      | coverage          |
+-------------------+----------------------+-------------------+
| **Piperaci        | 4.5 g IV Q6-8H       | Excellent         |
| llin-tazobactam** |                      | coverage;         |
|                   |                      | pseudomonal       |
+-------------------+----------------------+-------------------+
...
| Agent             | Dosing               | Notes             |
+===================+======================+===================+
| **Ceftriaxone**   | 2 g IV Q12H +        | Lower pseudomonal |
|                   | metronidazole 500 mg | coverage          |
|                   | TID                  |                   |
+-------------------+----------------------+-------------------+
| **Ceftazidime**   | 2 g IV Q8H +         | Better            |
|                   | metronidazole 500 mg | *Pseudomonas*     |
|                   | TID                  | coverage          |
+-------------------+----------------------+-------------------+
...
::: aside
To treat ESBL- or AmpC-producing Enterobacterales, all above antibiotics
can be used except for ceftolozane/tazobactam against hyperproducing
AmpC Enterobacterales. To treat ESBL-, AmpC- or KPC-producing
Enterobacterales, all can be used, but ceftolozane/tazobactam. To treat
ESBL-, AmpC, KPC, OXA-48 producing Enterobacterales, all but temocillin,
ceftolozane/tazobactam. meropenem/vaborbactam, imipenem/relebactam. To
treat ESBL-, AmpC, КРС, OXA-48, MBL-producing Enterobacterales, only
eravacycline, tigecycline, cefiderocol, and ampicillin/sulbactam plus
ceftazidime/avibactam. To treat CRAB, only eravacycline, tigecycline,
cefiderocol. To treat CRPA only cefiderocol (ceftolozane/tazobactam only
active against carbapenem-resistant, non-carbapenemase-producing
...
+================+===========================+==================+
| Ceftoloz       | Pseudomonas, resistant GN | Health           |
| ane-tazobactam |                           | care-associated, |
|                |                           | MDR risk         |
+----------------+---------------------------+------------------+
| Ceftazi        | Carbapenem-resistant      | Suspected        |
| dime-avibactam | organisms, ESBLs          | resistance,      |
|                |                           | prior            |
|                |                           | carbapenems      |
+----------------+---------------------------+------------------+
| Meropenem      | Metallo-β-lactamases,     | Last-resort      |
| -vaborbactam   | carbapenem-resistant      | therapy          |
+----------------+---------------------------+------------------+
...
+================+==================+===========================+
| Fluconazole    | 400-800 mg/day   | Upper GI perforation,     |
|                |                  | prolonged hospitalization |
+----------------+------------------+---------------------------+
| Anidulafungin  | 200 mg loading,  | Suspected azole-resistant |
|                | then 100 mg/day  | Candida                   |
+----------------+------------------+---------------------------+
| Caspofungin    | 70 mg loading,   | Alternative to            |
|                | then 50 mg/day   | fluconazole, Suspected    |
|                |                  | azole-resistant Candida   |
+----------------+------------------+---------------------------+
| Micafungin     | 100 mg daily     | Alternative to            |
|                |                  | fluconazole, Suspected    |
|                |                  | azole-resistant Candida   |
+----------------+------------------+---------------------------+
| Liposomal      | 3-5 mg/kg/day    | Suspected azole-resistant |
| amphotericin B |                  | Candida, nephrotoxic      |
+----------------+------------------+---------------------------+
...
::: aside
Source control is often MORE important than antibiotics in secondary
peritonitis. Antibiotics alone fail in cases of inadequate source
control. The timing of surgery depends on presentation (shock vs.
hemodynamically stable) and anatomical factors. Percutaneous drainage
under CT guidance is increasingly used for select abscess collections,
...
-   **Aggressive fluid resuscitation** (often requires 5-10 L in first
    24 hours)
...
-   **Correcting coagulopathy** (fresh frozen plasma, vitamin K,
    platelets)
...
# Peritoneal-dialysis assocaited peritonitis {background-color="#9B0014"}
...
+===================+======================+===================+
| **Gram-positive** | 60-80%               | S. epidermidis,   |
|                   |                      | S. aureus,        |
|                   |                      | Streptococcus     |
|                   |                      | spp.              |
+-------------------+----------------------+-------------------+
| **Gram-negative** | 15-30%               | E. coli,          |
|                   |                      | Klebsiella,       |
|                   |                      | Enterobacterales  |
+-------------------+----------------------+-------------------+
| **Fungi**         | 5-10% (increasing)   | Candida spp.,     |
|                   |                      | rare molds        |
+-------------------+----------------------+-------------------+
...
+================+==============================+================+
| **Cefazolin**  | 500 mg/2 L exchanges / 125   | Gram-positive  |
|                | mg/2 L                       | coverage       |
+----------------+------------------------------+----------------+
| -   \*C        | 500 mg/2 L exchanges / 125   | Gram-negative, |
| eftazidime\*\* | mg/2 L                       | Pseudomonas    |
+----------------+------------------------------+----------------+
| **Vancomycin** | 30 mg/kg loading / 15 mg/kg  | MRSA,          |
|                | per exchange                 | resistant      |
|                |                              | gram-positive  |
+----------------+------------------------------+----------------+
...
## PD Peritonitis: Outcomes and Catheter Removal {.aside}
...
+=================+================+============================+
| **Pelvic**      | 30-40%         | Dependent site; difficult  |
|                 |                | to examine                 |
+-----------------+----------------+----------------------------+
| **Paracolic     | 20-30%         | Follow colon anatomy       |
| gutters**       |                |                            |
+-----------------+----------------+----------------------------+
| **Subphrenic**  | 15-20%         | Upper abdomen; may         |
|                 |                | irritate diaphragm         |
+-----------------+----------------+----------------------------+
| **Hepa t        | 10-15%         | Near hepatic hilum,        |
| i               |                | fissures                   |
| c/Perihepatic** |                |                            |
+-----------------+----------------+----------------------------+
| **Morrison's    | 5-10%          | Dependent upper abdomen    |
| pouch**         |                |                            |
+-----------------+----------------+----------------------------+
...
-   Elevated CRP
-   CT findings: Fluid collection with enhancing rim, air-fluid level if
    gasforming organism
...
+=====================+======================+==================+
| **CT with IV        | 95-97%               | Gold standard;   |
| contrast**          |                      | localization;    |
|                     |                      | guidance for     |
|                     |                      | drainage         |
+---------------------+----------------------+------------------+
| **Ultrasound**      | 90-95%               | Real-time,       |
|                     |                      | portable;        |
|                     |                      | bedside          |
|                     |                      | assessment       |
+---------------------+----------------------+------------------+
| **MRI**             | 90-95%               | Excellent soft   |
|                     |                      | tissue; limited  |
|                     |                      | in acute care    |
+---------------------+----------------------+------------------+
...
abscess wall. Air within the collection suggests gasforming organisms
...
+================+==========================+===================+
| **Access**     | Image-guided (CT/US)     | Direct            |
|                |                          | visualization     |
+----------------+--------------------------+-------------------+
| -   \*In       | Minimally invasive       | Formal operation  |
|                |                          |                   |
| vasiveness\*\* |                          |                   |
+----------------+--------------------------+-------------------+
| **Morbidity**  | Lower                    | Higher (general   |
|                |                          | anesthesia,       |
|                |                          | incisions)        |
+----------------+--------------------------+-------------------+
| **Efficacy**   | 80-90% success           | Near 100% success |
+----------------+--------------------------+-------------------+
| **Best used    | Accessible collections,  | Inaccessible      |
| in**           | stable patient           | collections,      |
|                |                          | unstable patient  |
+----------------+--------------------------+-------------------+
...
-   **\>3-4 cm** in diameter (smaller often respond to antibiotics
    alone)
...
| Factor                         | Impact                         |
+================================+================================+
| **Time to diagnosis**          | Delayed diagnosis → higher     |
|                                | mortality                      |
+--------------------------------+--------------------------------+
| **Size \>5 cm**                | Larger collections → worse     |
|                                | prognosis                      |
+--------------------------------+--------------------------------+
| **Multiple organisms (esp.     | More virulent; worse outcome   |
| anaerobes)**                   |                                |
+--------------------------------+--------------------------------+
| **Associated peritonitis**     | Indicates severe primary       |
|                                | disease                        |
+--------------------------------+--------------------------------+
| **Patient age, comorbidities** | Older, immunocompromised →     |
|                                | worse                          |
+--------------------------------+--------------------------------+
...
+--------------+--------------+--------------+--------------+
| Clinical     | First-Line   | Alternative  | Duration     |
| Scenario     | Empiric      |              |              |
+==============+==============+==============+==============+
| **Primary    | Cefotaxime   | C            | 5 days       |
| peritonitis  | 2g Q6-8H     | iprofloxacin |              |
| (SBP)**      |              | 400mg PO     |              |
|              |              | Q12H         |              |
+--------------+--------------+--------------+--------------+
| **Secondary  | Piperacil l  | Ceftriaxone  | 10-14 days   |
| peritonitis, | i            | 2g Q12H +    |              |
| CA**         | n-tazobactam | m            |              |
|              | 4.5g Q6-8H   | etronidazole |              |
|              |              | 500mg TID    |              |
+--------------+--------------+--------------+--------------+
| **Secondary  | C e          | Carbapenem ± | 10-14 days   |
| peritonitis, | p            | anti-fungal  |              |
| HA**         | halosporin + |              |              |
|              | vancomycin + |              |              |
|              | anti-Candida |              |              |
+--------------+--------------+--------------+--------------+
| **CAPD       | Cefazolin    | Vancomycin   | 14-21 days   |
| p            | IP +         | IP           |              |
| eritonitis** | ceftazidime  |              |              |
|              | IP           |              |              |
+--------------+--------------+--------------+--------------+
| **In t       | Piperacil l  | C            | 10-14 days   |
| r            | i            | eftriaxone + |              |
| a-peritoneal | n-tazobactam | m            |              |
| abscess**    | 4.5g Q6-8H   | etronidazole |              |
+--------------+--------------+--------------+--------------+
...
-   UpToDate: "Spontaneous bacterial peritonitis" and "Secondary
    bacterial peritonitis"
-   Diagnostic Microbiology and Infectious Disease (journal)
-   Infectious Diseases Society of America online guidelines

::: notes
These resources provide deeper dives into specific topics and offer
access to the most current literature on emerging resistance and
treatment approaches. Many hospitals have access to UpToDate through
institutional subscriptions, and IDSA guidelines are freely available
online.
:::
