...
|                                |                                  |
|--------------------------------|----------------------------------|
| ![](images/dmmunipd_logo.jpeg) | ![](images/unipd_seal_white.svg) |
...
+==============+==============+=================+===================+
| In           | None         | Present <br> \| |                   |
| traabdominal |              | Persistent      |                   |
| source       |              | after source \| |                   |
|              |              | (perforation,   |                   |
|              |              | ischemia) \|    |                   |
|              |              | <br>control     |                   |
+--------------+--------------+-----------------+-------------------+
|              |              | Frequency       | \~1% of \| 80-90% |
|              |              |                 | of cases \| Less  |
|              |              |                 | common perit \|   |
|              |              |                 | \| \| onitis \|   |
|              |              |                 | \|                |
+--------------+--------------+-----------------+-------------------+
| Typical      | Mon          | Polymicrobial   | MDR, gram -       |
|              | omicrobial   | ae              | negative <br> low |
| organisms    | gram-        | robic/anaerobic | irulence          |
|              | negative     |                 |                   |
+--------------+--------------+-----------------+-------------------+
...
| Test              | Utility                           |
+===================+===================================+
| **C-reactive      | Elevated; reflects severity       |
| protein (CRP)**   |                                   |
+-------------------+-----------------------------------+
...
+----------------+----------------+----------------+
| Risk Category  | Features       | Typical        |
|                |                | Organisms      |
+================+================+================+
| **Low-risk**   | Commu          | Susceptible    |
|                | nity-acquired, | g              |
|                | no recent ho   | ram-negatives, |
|                | spitalization, | anaerobes      |
|                | no imm         |                |
|                | unosuppression |                |
+----------------+----------------+----------------+
| **High-risk**  | Healthca       | MDR            |
|                | re-associated, | g              |
|                | recent         | ram-negatives, |
|                | surgery, imm   | MRSA, Candida, |
|                | unosuppressed, | enterococci    |
|                | prolonged h    |                |
|                | ospitalization |                |
+----------------+----------------+----------------+
...
| ulanate\*\* |             |             |
+-------------+-------------+-------------+
| **Ampicill  | 3 g IV Q6H  | Good        |
| i n         |             | anaerobic   |
| -           |             | coverage    |
| sulbactam** |             |             |
+-------------+-------------+-------------+
| -   \*      | 4.5 g IV    | Excellent   |
| Piperacilli | Q6-8H       | coverage;   |
|     n       |             | pseudomonal |
| -   taz     |             |             |
| obactam\*\* |             |             |
+-------------+-------------+-------------+
...
| Agent       | Dosing      | Notes       |
+=============+=============+=============+
| Ceftriaxone | 2 g IV      | Lower       |
|             | Q12H + m    | pseudomonal |
|             | e           | coverage    |
|             | tronidazole |             |
|             | 500 mg TID  |             |
+-------------+-------------+-------------+
| Ceftazidime | 2 g IV      | Better      |
|             | Q8H + m     | *P          |
|             | e           | seudomonas* |
|             | tronidazole | coverage    |
|             | 500 mg TID  |             |
+-------------+-------------+-------------+
...
+----------------+------------------+----------------+
| Agent          | Organism         | When to Use    |
|                | Coverage         |                |
+================+==================+================+
| Ceftoloz       | Pseudomonas,     | Health ca      |
| ane-tazobactam | resistant GN     | re-associated, |
|                |                  | MDR risk       |
+----------------+------------------+----------------+
| Ceftazi        | Car              | Suspected      |
| dime-avibactam | b                | resistance,    |
|                | apenem-resistant | prior          |
|                | organisms, ESBLs | carbapenems    |
+----------------+------------------+----------------+
| Meropen        | M e t a          | Last-resort    |
| em-vaborbactam | l                | therapy        |
|                | lo-β-lactamases, |                |
|                | car              |                |
|                | b                |                |
|                | apenem-resistant |                |
...
+================+================+==================+
| Fluconazole    | 400-800 mg/day | Upper GI         |
|                |                | perforation,     |
|                |                | prolonged        |
|                |                | hospitalization  |
+----------------+----------------+------------------+
...
|                | (Bolus/Maintenance) |                |
+================+=====================+================+
| **Cefazolin**  | 500 mg/2 L          | Gram-positive  |
|                | exchanges / 125     | coverage       |
|                | mg/2 L              |                |
+----------------+---------------------+----------------+
| Ceftazidime    | 500 mg/2 L          | Gram-negative, |
|                | exchanges / 125     | Pseudomonas    |
|                | mg/2 L              |                |
+----------------+---------------------+----------------+
| **Vancomycin** | 30 mg/kg loading /  | MRSA,          |
|                | 15 mg/kg per        | resistant      |
|                | exchange            | gram-positive  |
+----------------+---------------------+----------------+
...
+================+================+===================+
| Pelvic         | 30-40%         | Dependent site;   |
|                |                | difficult to      |
|                |                | examine           |
+----------------+----------------+-------------------+
| Paracolic      | 20-30%         | Follow colon      |
|                |                | anatomy gutters   |
+----------------+----------------+-------------------+
| Subphrenic     | 15-20%         | Upper abdomen;    |
|                |                | may \| \| \|      |
|                |                | irritate          |
|                |                | diaphragm         |
+----------------+----------------+-------------------+
| Hepatic        | 10-15%         | Near hepatic      |
|                |                | hilum, fissures   |
|                |                | perihepatic       |
+----------------+----------------+-------------------+
...
+================+=================+================+
| **Access**     | Image-guided    | Direct         |
|                | (CT/US)         | visualization  |
+----------------+-----------------+----------------+
| In             | Minimally       | Formal         |
| vasiveness\*\* | invasive        | operation      |
+----------------+-----------------+----------------+
...
| Factor                | Impact                |
+=======================+=======================+
| **Time to diagnosis** | Delayed diagnosis →   |
|                       | higher mortality      |
+-----------------------+-----------------------+
| **Size \>5 cm**       | Larger collections →  |
|                       | worse prognosis       |
+-----------------------+-----------------------+
| **Multiple organisms  | More virulent; worse  |
| (esp. anaerobes)**    | outcome               |
+-----------------------+-----------------------+
| **Associated          | Indicates severe      |
| peritonitis**         | primary disease       |
+-----------------------+-----------------------+
| **Patient age,        | Older,                |
...
+-------+-------+-------+-------+
| C l i | F i r | A l t | D u r |
| nical | s t   | e r n | ation |
| S c e | -Line | ative |       |
| nario | E m   |       |       |
|       | piric |       |       |
+=======+=======+=======+=======+
