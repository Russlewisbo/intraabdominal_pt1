...
+---------------------------+-----------------------------+
| ! [                       | ![](image                   |
| ](im%20ages/              | s/u%20n%20i%20p%20d%20_%20s |
| d%20m%20m%20u%20n%20i%20p | eal_white.svg){width="100"} |
| d_logo.jpeg){width="100"} |                             |
+---------------------------+-----------------------------+
...
|           |           | ischemia) |           |
+-----------+-----------+-----------+-----------+
| -   \*Fr  | \~1% of p | 80-90% of | Less      |
|     e     | e         | cases     | common    |
|     q     | ritonitis |           |           |
| uency\*\* |           |           |           |
+-----------+-----------+-----------+-----------+
| **Typical | M o n     | P o l     | MDR, g r  |
| o         | o         | y         | a         |
| r         | microbial | microbial | m         |
| ganisms** | g r a     | ae r o b  | -negative |
|           | m         | i c       | <br       |
|           | -negative | /         | > l o w   |
|           |           | anaerobic | -         |
|           |           |           | virulence |
...
+-----------------------+-----------------------------------+
| **Lactate**           | Elevated in sepsis; correlates    |
|                       | with severity                     |
+-----------------------+-----------------------------------+
...
| Agent          | Dosing           | Notes          |
+================+==================+================+
| **Amoxicil l i | 875-125 mg TID   | Oral; limited  |
| n              |                  | spectrum       |
| -clavulanate** |                  |                |
+----------------+------------------+----------------+
| **Ampic i l l  | 3 g IV Q6H       | Good anaerobic |
| in-sulbactam** |                  | coverage       |
+----------------+------------------+----------------+
| **Piperaci l l | 4.5 g IV Q6-8H   | Excellent      |
| i              |                  | coverage;      |
| n-tazobactam** |                  | pseudomonal    |
+----------------+------------------+----------------+
...
+================+==================+================+
| -   \*C        | 2 g IV Q12H +    | Lower          |
| eftriaxone\*\* | metronidazole    | pseudomonal    |
|                | 500 mg TID       | coverage       |
+----------------+------------------+----------------+
| -   \*C        | 2 g IV Q8H +     | Better         |
| eftazidime\*\* | metronidazole    | *Pseudomonas*  |
|                | 500 mg TID       | coverage       |
+----------------+------------------+----------------+
...
+================+=======================+================+
| Ceftoloz       | Pseudomonas,          | Health c a     |
| ane-tazobactam | resistant GN          | re-associated, |
|                |                       | MDR risk       |
+----------------+-----------------------+----------------+
...
|                | loading, then  | azole-resistant       |
|                | 100 mg/day     | Candida               |
+----------------+----------------+-----------------------+
| Caspofungin    | 70 mg loading, | Alternative to        |
|                | then 50 mg/day | fluconazole,          |
|                |                | Suspected             |
|                |                | azole-resistant       |
|                |                | Candida               |
+----------------+----------------+-----------------------+
...
|                | (Bolus/Maintenance)      |                |
+================+==========================+================+
| **Cefazolin**  | 500 mg/2 L exchanges /   | Gram-positive  |
|                | 125 mg/2 L               | coverage       |
+----------------+--------------------------+----------------+
| Ceftazidime    | 500 mg/2 L exchanges /   | Gram-negative, |
|                | 125 mg/2 L               | Pseudomonas    |
+----------------+--------------------------+----------------+
...
| \| \|          |                |                        |
+----------------+----------------+------------------------+
| **Morrison's   | 5-10%          | Dependent upper        |
| pouch**        |                | abdomen                |
+----------------+----------------+------------------------+
...
|                            | prognosis                  |
+----------------------------+----------------------------+
| **Multiple organisms (esp. | More virulent; worse       |
| anaerobes)**               | outcome                    |
+----------------------------+----------------------------+
...
+-----------+-----------+-----------+-----------+
| Clinical  | F         | A l       | Duration  |
| Scenario  | irst-Line | ternative |           |
|           | Empiric   |           |           |
+===========+===========+===========+===========+
| **Primary | C         | C i p r   | 5 days    |
| p e       | efotaxime | ofloxacin |           |
| ritonitis | 2g Q6-8H  | 400mg PO  |           |
| (SBP)**   |           | Q12H      |           |
+-----------+-----------+-----------+-----------+
| -   \*    | Piperacil | C e       | 10-14     |
|           | l i n - t | ftriaxone | days      |
| Secondary | azobactam | 2g Q12H + |           |
|     p e r | 4.5g      | m e t r   |           |
|           | Q6-8H     | onidazole |           |
| itonitis, |           | 500mg TID |           |
|           |           |           |           |
...
| -   \*    | C e p h a | C         | 10-14     |
|           | l         | arbapenem | days      |
| Secondary | osporin + | ± a n     |           |
|     p e r | v a n     | ti-fungal |           |
|           | comycin + |           |           |
| itonitis, | a n t     |           |           |
|           | i-Candida |           |           |
| HA\*\*    |           |           |           |
+-----------+-----------+-----------+-----------+
| **CAPD p  | Cefazolin | V         | 14-21     |
| e r i     | IP + c e  | ancomycin | days      |
| tonitis** | ftazidime | IP        |           |
|           | IP        |           |           |
+-----------+-----------+-----------+-----------+
| ## \*     | Piperacil | C e f t   | 10-14     |
|           | l i n - t | riaxone + | days      |
| \*In t r  | azobactam | m e t r   |           |
| a         | 4.5g      | onidazole |           |
|           | Q6-8H     |           |           |
| p         |           |           |           |
| eritoneal |           |           |           |
